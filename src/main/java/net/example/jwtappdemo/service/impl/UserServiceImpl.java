package net.example.jwtappdemo.service.impl;
...
import net.example.jwtappdemo.repository.RoleRepository;
import net.example.jwtappdemo.repository.UserRepository;
